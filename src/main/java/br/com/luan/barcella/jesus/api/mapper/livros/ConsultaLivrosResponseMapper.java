...
import br.com.luan.barcella.jesus.api.dto.response.ConsultaLivrosResponse.Abreviacao;
...
public class ConsultaLivrosResponseMapper implements Function<List<ConsultaLivrosBibliaDigitalResponse>, List<ConsultaLivrosResponse>> {
    ...
    private Abreviacao buildAbreviacao(final ConsultaLivrosBibliaDigitalResponse.Abreviacao abreviacao) {
        return Abreviacao.builder()
